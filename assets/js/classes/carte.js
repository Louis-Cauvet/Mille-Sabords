  ...
  appliquerEffet() {
    ...
    switch (this.nom) {
      case "pirate":
        ...
        textDescription =
          "Tous les points obtenus durant ce tour sont doublés. Si le joueur doit se rendre sur lîle de La " +
      ...
      case "bateau_300":
        ...
        textDescription =
          ...
          "ne peut pas aller sur lîle de la Tête-de-Mort :un joueur qui obtiendrait 4 têtes de mort ou plus " +
